...
const CATALOG: CatalogEntry[] = [
  ...
  },
  {
    ...
    name: "DigitalOcean",
    brandColor: "#0080ff",
    logoPath: "/merchants/digitalocean.png",
    needles: ["digitalocean", "digital ocean"],
  },
  {
    key: "hetzner",
    name: "Hetzner",
    brandColor: "#d50c2d",
    logoPath: "/merchants/hetzner.svg",
    needles: ["hetzner"],
  },
  {
    key: "ionos",
  ...
  },
  {
    ...
    name: "Dropbox",
    brandColor: "#0061ff",
    logoPath: "/merchants/dropbox.png",
    needles: ["dropbox"],
  },
  {
    key: "mega-nz",
    name: "MEGA",
    brandColor: "#d31b00",
    logoPath: "/merchants/mega-nz.svg",
    // "mega" alone also names an Israeli supermarket and is too broad.
    needles: ["mega nz", "mega co nz"],
  },
  {
    key: "israel-electric",
  ...
  },
  {
    ...
    name: "חברת הגיחון",
    brandColor: "#0072bc",
    logoPath: "/merchants/gihon.png",
    needles: ["חברת הגיחון", "הגיחון"],
  },
  {
    key: "moovit",
    name: "Moovit",
    brandColor: "#ff5c00",
    logoPath: "/merchants/moovit.png",
    needles: ["moovit", "מוביט"],
  },
  {
    key: "meuhedet",
    name: "Meuhedet",
