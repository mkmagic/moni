...
2. **Prefer WebAuthn/passkeys with the PRF extension** to derive the unlock key from a biometric/security-key tap. Fall back to a password via **Argon2id**. AEAD everywhere = **XChaCha20-Poly1305**.
